...
@section('contents')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="{{ route('buat.suratmasuk') }}" class="btn btn-info mb-3">Add Mail</a>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @foreach ($dataSuratMasuk as $row)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-secondary" data-toggle="modal"
                                        data-target="#detailSuratMasukModal{{ $row->no_surat }}">
                                        <i class="fas fa-file-invoice"></i>
                                    </button>
                                    <a href="{{ route('ubah.SuratMasuk', $row->no_surat) }}" class="btn btn-warning">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('pegawai.deletesuratmasuk', $row->no_surat) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="modal fade" id="detailSuratMasukModal{{ $row->no_surat }}" tabindex="-1"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p><strong>Tanggal Surat Masuk:</strong> {{ $row->tgl_input_surat }}</p>
