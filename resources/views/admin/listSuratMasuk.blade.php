...
@section('contents')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="/add-incoming-mail" class="btn btn-info mb-3">Add Mail</a>
                        ...
                        @foreach ($dataSuratMasuk as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('suratmasuk.edit', $row->no_surat) }}" class="btn btn-warning">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('suratmasuk.delete', $row->no_surat) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
