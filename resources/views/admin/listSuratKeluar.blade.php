...
@section('contents')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <a href="{{ route('addSuratKeluar') }}" class="btn btn-info mb-3">Add Mail</a>
                        ...
                        @foreach ($dataSuratKeluar as $row)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if ($row->status == 0)
                                        <a href="{{ route('tambahPengiriman', $row->no_surat) }}" class="btn btn-primary">
                                            <i class="fas fa-paper-plane"></i>
                                        </a>
                                    @else
                                    @endif
                                    <a href="{{ route('suratkeluar.edit', $row->no_surat) }}" class="btn btn-warning">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="{{ route('suratkeluar.delete', $row->no_surat) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
