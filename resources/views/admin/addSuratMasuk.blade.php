@extends('layouts.app')
@section('title', 'Add Incoming Mails')
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Add Incoming Mails</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('addSuratMasuk') }}" method="POST">
                        @csrf
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('listSuratMasuk') }}" class="btn btn-danger">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
