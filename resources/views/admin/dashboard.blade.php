...
@section('contents')
    ...
    <div class="row">
        <div class="col-lg-7 mb-2">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-info">Profile Admin</h6>
                </div>
                <div class="card-body text-center py-8">
                    <div class="row justify-content-center align-items-center text-center"> <!-- Menambahkan justify-content-center dan align-items-center -->
                        <div class="flex flex-col items-center pb-10 text-center">
                            <img class="img-profile rounded-circle mb-3" src="img/undraw_profile.svg" style="width: 100px; height: 100px;"> <!-- Menambahkan mb-3 untuk margin-bottom -->
        ...
        <div class="col-lg-5 mb-1">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-info">Account Monitoring</h6>
                </div>
                <div class="card-body ">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-xl-10 col-md-6 mb-3">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Admin</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">008</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-10 col-md-6 mb-1">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Pegawai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">020</div>
                                        </div>
                                        <div class="col-auto">
